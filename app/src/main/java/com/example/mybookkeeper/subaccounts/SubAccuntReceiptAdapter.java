...
public class SubAccuntReceiptAdapter<S> extends RecyclerView.Adapter<SubAccuntReceiptAdapter.ReceiptDataViewHolder>
    ...
    SubAccuntReceiptAdapter(Context context, RefreshableFragment refreshable, ArrayList<ReceiptData> listReceiptDatas, int clientId) {
