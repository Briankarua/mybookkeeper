...
public class ExpenseAdapter<S> extends RecyclerView.Adapter<ExpenseAdapter.ExpenseDataViewHolder>
    ...
    @Override
    public ExpenseAdapter. ExpenseDataViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new ExpenseAdapter.ExpenseDataViewHolder(view);
    }

    @Override
    public void onBindViewHolder(ExpenseAdapter.ExpenseDataViewHolder holder, int position) {
