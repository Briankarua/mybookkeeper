...
public class SubAccountReceiptsFragment extends Fragment implements RefreshableNavigatable {
    ...
    public static SubAccountReceiptsFragment getInstance(int clientID){
        SubAccountReceiptsFragment r = new SubAccountReceiptsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        com.example.mybookkeeper.fragmernts.receipts.ReceiptData ReceiptData = null;
        Bundle args = getArguments();

        View v = inflater.inflate(R.layout.fragment_sub_account_receipts, container, false);
...
//        });
    ...
    public void refresh(){
        ...
        if (allReceipts.size() > 0) {
            ...
            SubAccuntReceiptAdapter mAdapter = new SubAccuntReceiptAdapter(getActivity(),  this, allReceipts, getArguments().getInt("clientIDFFromGallety"));
